...
for iter in range(start_row, campaign_df.shape[0]):
    ...
    if iter % 100 == 0:
        ...
        data_df.to_csv("c:\\Users\\Satishwar Kedas\\OneDrive - Oklahoma A and M System\\Documents\\GitHub\\project-deliverable-1-invincible\\data\\raw_data\\campaigns\\campaign_raw_{}.csv".format(int(data_df.shape[0]) + 1))
    else:
        continue
