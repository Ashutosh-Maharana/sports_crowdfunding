...
# 
# df_raw = pd.DataFrame()
# for file in os.listdir("c:\\Users\\Satishwar Kedas\\OneDrive - Oklahoma A and M System\\Documents\\GitHub\\project-deliverable-1-invincible\\data\\raw_data"):
#     df_file = pd.read_csv("c:\\Users\\Satishwar Kedas\\OneDrive - Oklahoma A and M System\\Documents\\GitHub\\project-deliverable-1-invincible\\data\\raw_data\\{}".format(file))
...
# df_raw = pd.DataFrame()
# for file in os.listdir("C:\\Users\\ashut_8g2sbcn\\OneDrive - Oklahoma A and M System\\Fall_2022\\MSIS_5193_Programming\\project-deliverable-1-invincible\\data\\raw_data"):
#     df_file = pd.read_csv("C:\\Users\\ashut_8g2sbcn\\OneDrive - Oklahoma A and M System\\Fall_2022\\MSIS_5193_Programming\\project-deliverable-1-invincible\\data\\raw_data\\{}".format(file))
#     df_raw = pd.concat([df_file, df_raw], ignore_index = True)
#     df_raw = df_raw.append(df_file, ignore_index = True)
#     del(df_file)
...
df_raw = pd.DataFrame()
for file in os.listdir("C:\\Users\\yash1\\OneDrive - Oklahoma A and M System\\MAIN DRIVE\\MSIS5193 (Programming for Data Science)\\project-deliverable-1-invincible\\data\\raw_data"):
    df_file = pd.read_csv("C:\\Users\\yash1\\OneDrive - Oklahoma A and M System\\MAIN DRIVE\\MSIS5193 (Programming for Data Science)\\project-deliverable-1-invincible\\data\\raw_data\\{}".format(file))
    df_raw = pd.concat([df_file, df_raw], ignore_index = True)
    df_raw = df_raw.append(df_file, ignore_index = True)
    del(df_file)
...
#%%
# os.mkdir("c:\\Users\\Satishwar Kedas\\OneDrive - Oklahoma A and M System\\Documents\\GitHub\\project-deliverable-1-invincible\\data\\clean_data")
# df_clean.to_csv("c:\\Users\\Satishwar Kedas\\OneDrive - Oklahoma A and M System\\Documents\\GitHub\\project-deliverable-1-invincible\\data\\clean_data\\main_data_clean.csv")


# os.mkdir("c:\\Users\\Satishwar Kedas\\OneDrive - Oklahoma A and M System\\Documents\\GitHub\\project-deliverable-1-invincible\\data\\clean_data")
# df_clean.to_csv("C:\\Users\\ashut_8g2sbcn\\OneDrive - Oklahoma A and M System\\Fall_2022\\MSIS_5193_Programming\\project-deliverable-1-invincible\\data\\clean_data\\main_data_clean.csv")

df_clean.to_csv("C:\\Users\\yash1\\OneDrive - Oklahoma A and M System\\MAIN DRIVE\\MSIS5193 (Programming for Data Science)\\project-deliverable-1-invincible\\data\\clean_data\\main_data_clean.csv")
